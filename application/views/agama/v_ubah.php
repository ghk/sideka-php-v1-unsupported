...
<?php echo form_open('pustaka/c_agama/update_agama'); ?>
<fieldset>
	<legend></legend>
	<!-- Text input-->
	<div class="form-group">
		<div class="col-md-9">
			<input  value="<?= $hasil->id_agama?>" id="id_agama" name="id_agama" type="hidden" placeholder="Deskripsi" class="form-control input-md">
			<span class="help-block"><?php echo form_error('id_agama', '<p class="field_error">','</p>')?></span>  
		</div>
	</div>
