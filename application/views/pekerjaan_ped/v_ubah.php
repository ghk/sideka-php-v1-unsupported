...
<?php echo form_open('datapenduduk/c_pekerjaan_ped/update_pekerjaan_ped'); ?>
<fieldset>
	<legend></legend>
	<!-- Text input-->
	<div class="form-group">
		<div class="col-md-9">
			<input  value="<?= $hasil->id_pekerjaan_ped?>" id="id_pekerjaan_ped" name="id_pekerjaan_ped" type="hidden" placeholder="id" class="form-control input-md">
			<span class="help-block"><?php echo form_error('id_pekerjaan_ped', '<p class="field_error">','</p>')?></span>  
		</div>
	</div>
...
<input type="button" value="Batal" id="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>datapenduduk/c_pekerjaan_ped'"/>
</p>
...
function nav_active(){
	...
	var d = document.getElementById("nav-pekerjaan_ped");
