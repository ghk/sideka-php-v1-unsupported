...
<?php echo form_open('admin/c_kabkota/simpan_kabkota'); ?>
<legend></legend>
	<div class="form-group">
    	<label class="col-md-3 control-label" for="kode_kab_kota_bps">Kode BPS </label>
        <div class="col-md-9"> 
        <span class="help-block">
        <input class="form-control input-md" type="text" name="kode_kab_kota_bps" id="kode_kab_kota_bps" size="30" placeholder="Kode Kabupaten Kota BPS (Badan Pusat Statistik)"/> 
	...
	<div class="form-group">
        ...
        <div class="col-md-9">
        <span class="help-block">
         <input class="form-control input-md" type="text" name="kode_kab_kota_kemendagri" id="kode_kab_kota_kemendagri" size="30" placeholder="Kode Kabupaten Kota Kemendagri"/> 
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
        <span class="help-block"> 
         <input class="form-control input-md" type="text" name="nama_kab_kota" id="nama_kab_kota" size="30" placeholder="Nama Kabupaten Kota"/>
		</span> 
	...
	<div class="form-group">
        ...
        <div class="col-md-9">
        <span class="help-block"> 
         <input class="form-control input-md" type="text" name="luas_wilayah" id="luas_wilayah" size="30" placeholder="Luas Wilayah Kabupaten Kota (km2)" /> 
		</span>
