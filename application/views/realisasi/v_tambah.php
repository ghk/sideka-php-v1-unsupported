...
<?php echo form_open('apbdes/c_realisasi/simpan'); ?>
<fieldset>
	<legend></legend>
		...
		<div class="col-md-9">
			<a href="javascript:NewCssCal('tanggal','ddmmyyyy')">
				<div class="input-group">
					...
					<input readonly="readonly" class="form-control" type="text"  name="tanggal" id="tanggal" size="20" placeholder="Tgl-Bln-Thn" class="form-control input-md" required="" />
				</div>
			</a>
