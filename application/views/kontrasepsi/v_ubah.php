...
<?php echo form_open('pustaka/c_kontrasepsi/update_kontrasepsi'); ?>
<fieldset>
	<legend></legend>
	<!-- Text input-->
	<div class="form-group">
		<div class="col-md-9">
			<input  value="<?= $hasil->id_kontrasepsi?>" id="id_kontrasepsi" name="id_kontrasepsi" type="hidden" placeholder="Deskripsi" class="form-control input-md">
			<span class="help-block"><?php echo form_error('id_kontrasepsi', '<p class="field_error">','</p>')?></span>  
		</div>
	</div>
...
<input type="button" value="Batal" id="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>pustaka/c_kontrasepsi'"/>
</p>
...
function nav_active(){
	...
	var d = document.getElementById("nav-kontrasepsi");
