...
<?php echo form_open('admin/c_ped_sumber_energi/update_ped_sumber_energi'); ?>
<input type="hidden" name="id_ped_sumber_energi" id="id_ped_sumber_energi" size="30" value="<?= $hasil->id_ped_sumber_energi?>" readonly = "readonly"/>
		...
		<div class="form-group">
				  ...
				  <div class="col-md-9">
					...
					<button id="batal" name="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>admin/c_ped_sumber_energi'">Batal</button>
				  </div>
				</div>
		</fieldset>
		<br>
...
<script>
 function nav_active(){
	...
	var d = document.getElementById("nav-sumber_energi");
