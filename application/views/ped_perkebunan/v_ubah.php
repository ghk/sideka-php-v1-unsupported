...
<?php echo form_open('admin/c_ped_perkebunan/update_ped_perkebunan'); ?>
<input type="hidden" name="id_ped_perkebunan" id="id_ped_perkebunan" size="30" value="<?= $hasil->id_ped_perkebunan?>" readonly = "readonly"/>
	...
	<fieldset>
		...
		<div class="form-group">
				  ...
				  <div class="col-md-9">
					...
					<button id="batal" name="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>admin/c_ped_perkebunan'">Batal</button>
				  </div>
				</div>
		</fieldset>
		<br>
