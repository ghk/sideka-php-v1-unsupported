...
<?php echo form_open('admin/c_ped_pertambakan/update_ped_pertambakan'); ?>
<input type="hidden" name="id_ped_pertambakan" id="id_ped_pertambakan" size="30" value="<?= $hasil->id_ped_pertambakan?>" readonly = "readonly"/>
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<?php $options = array(
					...
					echo form_dropdown('penggarap',$options,$hasil->penggarap,$id); ?>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="jumlah_penggarap" name="jumlah_penggarap" type="text" placeholder="Jumlah orang" class="form-control input-md" value="<?= $hasil->jumlah_penggarap?>" onkeypress="return numbersonly(event)" required>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="luas" name="luas" type="text" placeholder="Luas" class="form-control input-md" value="<?= $hasil->luas?>" onkeypress="return numbersonly(event)" required>
		...
		<div class="form-group">
				  ...
				  <div class="col-md-9">
					...
					<button id="batal" name="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>admin/c_ped_pertambakan'">Batal</button>
				  </div>
				</div>
		</fieldset>
		<br>
...
<script>
 function nav_active(){
	...
	var d = document.getElementById("nav-pertambakan");
