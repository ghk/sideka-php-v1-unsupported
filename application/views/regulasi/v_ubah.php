...
<input type="hidden" name="id_regulasi" id="id_regulasi" value="<?= $hasil->id_regulasi?>" readonly = "readonly"/>
    <div class="form-group">
        ...
        <div class="col-md-9">
         ...
         <input class="form-control input-md" type="text" name="judul_regulasi" id="judul_regulasi" value="<?= $hasil->judul_regulasi?>" /> 
	...
	<div class="form-group">
        ...
        <div class="col-md-9">
         <span class="help-block">
		 <textarea class="form-control input-md" rows="5" name="isi_regulasi" id="isi_regulasi"> <?=$hasil->isi_regulasi?></textarea>
	...
	<div class="form-group"> 	
        ...
        <div class="col-md-9">
         <span class="help-block">
			<input class="form-control input-md"  type="file" name="file_regulasi" id="file_regulasi" value="<?= $file?>" />
