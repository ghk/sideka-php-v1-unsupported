...
<?php echo form_open('pustaka/c_goldar/update_goldar'); ?>
<fieldset>
	<legend></legend>
	<!-- Text input-->
	<div class="form-group">
		<div class="col-md-9">
			<input  value="<?= $hasil->id_goldar?>" id="id_goldar" name="id_goldar" type="hidden" placeholder="Deskripsi" class="form-control input-md">
			<span class="help-block"><?php echo form_error('id_goldar', '<p class="field_error">','</p>')?></span>  
		</div>
	</div>
...
<input type="button" value="Batal" id="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>pustaka/c_goldar'"/>
</p>
...
function nav_active(){
	...
	var d = document.getElementById("nav-goldar");
