...
<?php echo form_open('pustaka/c_alasan_pindah/update_alasan_pindah'); ?>
<fieldset>
	<legend></legend>
	<!-- Text input-->
	<div class="form-group">
		<div class="col-md-9">
			<input  value="<?= $hasil->id_alasan_pindah?>" id="id_alasan_pindah" name="id_alasan_pindah" type="hidden" placeholder="Deskripsi" class="form-control input-md">
			<span class="help-block"><?php echo form_error('id_alasan_pindah', '<p class="field_error">','</p>')?></span>  
		</div>
	</div>
...
<input type="button" value="Batal" id="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>pustaka/c_alasan_pindah'"/>
</p>
...
function nav_active(){
	...
	var d = document.getElementById("nav-alasan_pindah");
