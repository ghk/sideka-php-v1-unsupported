...
<?php echo form_open('admin/c_ped_pertanian/update_ped_pertanian'); ?>
<input type="hidden" name="id_ped_pertanian" id="id_ped_pertanian" size="30" value="<?= $hasil->id_ped_pertanian?>" readonly = "readonly"/>
