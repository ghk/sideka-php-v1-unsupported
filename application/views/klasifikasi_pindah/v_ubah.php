...
<fieldset>
	...
	<div class="form-group">
		<div class="col-md-9">
			<input  value="<?= $hasil->id_klasifikasi_pindah?>" id="id_klasifikasi_pindah" name="id_klasifikasi_pindah" type="hidden" placeholder="Deskripsi" class="form-control input-md">
