...
<script type="text/javascript">
	...
	Highcharts.setOptions({
        colors: ['#FF9655', '#50B432', '#ED561B', '#DDDF00', '#24CBE5', '#64E572','#058DC7', '#FFF263', '#6AF9C4']
    });
	var chart ;
	$(document).ready(function () {
		...
		$('#container').highcharts({
			...
			subtitle: {
				text: 'Menurut Pekerjaan Penduduk'
			},
			tooltip: {
			...
			series: [{
				...
				data: [
					...
					['<?php echo $pekerjaan[$count] ?>', <?php echo $jumlahPenduduk[$count] ?>],
