...
<?php echo form_open('admin/c_ped_sumber_air/update_ped_sumber_air'); ?>
<input type="hidden" name="id_ped_sumber_air" id="id_ped_sumber_air" size="30" value="<?= $hasil->id_ped_sumber_air?>" readonly = "readonly"/>
		...
		<div class="form-group">
				  ...
				  <div class="col-md-9">
					...
					<button id="batal" name="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>admin/c_ped_sumber_air'">Batal</button>
				  </div>
				</div>
		</fieldset>
		<br>
...
<script>
 function nav_active(){
	...
	var d = document.getElementById("nav-sumber_air");
