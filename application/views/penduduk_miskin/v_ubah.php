...
<?php echo form_open_multipart('datapenduduk/c_penduduk_miskin/update_penduduk_miskin'); ?>
	<fieldset>
		<!-- Form Name -->
		<legend></legend>
		...
		<div class="form-group">
		  <div class="col-md-9">
		  <input  value="<?= $hasil->id_penduduk_miskin?>" id="id_penduduk_miskin" name="id_penduduk_miskin" type="hidden" placeholder="NIK / Nama Penduduk" class="form-control input-md">
		  <span class="help-block"><?php echo form_error('id_penduduk_miskin', '<p class="field_error">','</p>')?></span>  
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-md-9">
			...
			<button id="batal" name="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>datapenduduk/c_penduduk_miskin'">Batal</button>
		  </div>
		</div>
